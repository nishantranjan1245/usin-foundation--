...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "USIN Foundation encourages resolution of disputes through mutual discussion before resorting to legal action.",
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                USIN Foundation is committed to maintaining the highest standards of integrity 
